...
### Identity / history (Archive later — Founder 2026-08-06)

- **Family:** Founder’s sister (younger).  
- **Orbios:** ex-partner / prior business entanglement.  
- **Past:** toxic history — not erased; not for public OS / unit-facing narrative.  
- **TODO:** pack full identity + ex-partner + toxic arc into **Archive** (erik-sytnyk-os / private archive surface) when Founder opens Archive pass. Until then — this stub + K-001 hold the pointer.
...
- TG intro (ops only): `[see orbios-os:log/vector/outbound/2026-08-06-tg-tax-2025-group-intro.md]`
